/**
 * @file FeedBack.cpp
 * @brief Comprehensive real-time servo feedback monitoring for STS3215 protocol servos
 * 
 * @details
 * This example demonstrates efficient real-time reading of all available feedback data
 * from Feetech STS3215 protocol servos. It uses a single FeedBack() command to retrieve
 ...
 * 
 * @see STS3215::FeedBack()
 * @see STS3215::ReadPos()
 * @see STS3215::ReadSpeed()
 * @see STS3215::ReadLoad()
 * @see STS3215::ReadVoltage()
 * @see STS3215::ReadTemper()
 * @see STS3215::ReadMove()
 * @see STS3215::ReadCurrent()
 */
#include <iostream>
