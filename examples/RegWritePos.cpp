 ...
 * @brief Deferred multi-servo position commands with acceleration control for STS3215 protocol
 * 
 * @details
 ...
 * 
 * @see STS3215::RegWritePosEx()
 * @see STS3215::RegWriteAction()
 * @see STS3215::SyncWritePosEx() for alternative synchronization method
 */
/*
