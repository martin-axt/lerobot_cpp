/**
 * @file SyncRead.cpp
 * @brief Synchronized bulk feedback reading from multiple STS3215 protocol servos
 * 
 * @details
 ...
 * - Starting address: STS3215_PRESENT_POSITION_L (0x38)
 ...
 * 
 * @see STS3215::syncReadBegin()
 * @see STS3215::syncReadPacketTx()
 * @see STS3215::syncReadPacketRx()
 * @see STS3215::FeedBack() for single-servo alternative
 */
/*
...
int main(int argc, char **argv)
{
	...
	while(1){
		sm_st.syncReadPacketTx(ID, sizeof(ID)/sizeof(ID[0]), STS3215_PRESENT_POSITION_L, sizeof(rxPacket));//Synchronous read command packet transmission
