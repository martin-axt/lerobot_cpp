/**
 * @file ServoUtils.h
 * @brief Utility functions for lerobot_cpp SDK implementing DRY principle
 *
 ...
 * @see STS3215.cpp for usage examples
 */
 ...
 *
 * This eliminates instances of duplicate direction encoding logic across:
 * STS3215.cpp
 */
 ...
 * @param servoInstance Reference to servo object (STS3215, etc)
